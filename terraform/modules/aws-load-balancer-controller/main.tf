...
resource "helm_release" "aws_load_balancer_controller" {
  ...
  # Ensure ALB controller finalizers are handled properly
  set {
    name  = "defaultTags.Terraform"
    value = "true"
  }

  # Enable finalizer protection removal during uninstall
  set {
